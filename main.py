...
class Ui_AISearchingTechniquesMainWindow(object):
        ...
        with open('test.txt', 'w') as f:
            ...
            if (graphType == "Undirectd Graph"):
                if searchType == "BFS":
                    ...
                    start = self.StartNode_input.text()
                    goals = Goal_list
                    traced_path2,current_cost = graphdls.depth_limited_search(start, goals)
                    if (traced_path2):
                        print('Path:', end=' ')
    ...
    def retranslateUi(self, AISearchingTechniquesMainWindow):
        ...
        self.SearchTypecomboBox.setItemText(6, _translate("AISearchingTechniquesMainWindow", "Bidirect"))
        self.SearchTypecomboBox.setItemText(7, _translate("AISearchingTechniquesMainWindow", "BESTF"))
        self.SearchTypecomboBox.setItemText(8, _translate("AISearchingTechniquesMainWindow", "SIMULATED"))
        self.SearchTypecomboBox.setItemText(9, _translate("AISearchingTechniquesMainWindow", "ALPHABETA"))
